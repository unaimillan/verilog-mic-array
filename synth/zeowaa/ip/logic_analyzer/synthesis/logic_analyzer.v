...
module logic_analyzer (
		...
		input  wire        storage_enable, // storage_qualifier.storage_enable
		input  wire [23:0] acq_data_in,    //               tap.acq_data_in
		input  wire [0:0]  acq_trigger_in  //                  .acq_trigger_in
	);

	sld_signaltap #(
		.sld_data_bits                    (24),
		.sld_sample_depth                 (32768),
