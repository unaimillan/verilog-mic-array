...
def main():
    ...
    # args.output_dir = 'de10lite_build'
    args.cpu_type = 'femtorv'
    args.cpu_variant = 'quark'
    # args.cpu_variant = 'electron'
    # args.cpu_variant = 'gracilis'
    # args.cpu_variant = 'petitbateau'
    ...
    builder = Builder(soc, **(parser.builder_argdict | dict(compile_software=False, compile_gateware=False)))
    if args.build:
        # print(parser.toolchain_argdict)
